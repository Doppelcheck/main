...
class AgentExtraction:
    ...
    def __init__(self, config: dict[str, any]) -> None:
        ...
        self._prompt_extraction = (
            ...
            f"\n"
            f"Clearly reference the range of line numbers corresponding to each extracted statement. Ensure that the "
            f"statements are brief, clear, and directly convey the essential information. Use only up to 20 words for "
            f"each statement.\n"
            f"\n"
