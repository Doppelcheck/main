...
<svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <circle cx="50" cy="50" r="30" stroke="black" stroke-width="3" fill="none">
    <animate attributeName="r" from="30" to="45" dur="1s" begin="0s" repeatCount="indefinite"/>
    <animate attributeName="opacity" from="1" to="0.1" dur="1s" begin="0s" repeatCount="indefinite"/>
  </circle>
</svg>
