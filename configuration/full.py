...
async def full_configuration(user_id: str | None, address: str, version: str) -> None:
    ...
    ui.label("Doppelcheck configuration").classes("w-full text-h2 text-white p-4")
